...
import energysource.EnergySource;
import energysource.GasTank;
...
public class Vehicle {
	...
	public Vehicle(double speed, Direction direction, String owner, EnergySource source) {
		super();
		this.speed = speed;
	...
	public Vehicle(String owner) {
		this(0, null, owner, new GasTank());
	}

	public Vehicle() {
		this(0, null, null, new GasTank());
	}
