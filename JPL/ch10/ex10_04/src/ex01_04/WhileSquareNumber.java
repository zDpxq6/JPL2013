 ...
 * */
public class WhileSquareNumber implements SquareNumber {
	private final List<Integer> squareNumber = new LinkedList<Integer>();

	private WhileSquareNumber() {
		super();
	}
	 ...
	 * */
	public static WhileSquareNumber createSquareNumber(int terminationCondition) {
		if (terminationCondition < 0) {
			throw new IllegalArgumentException();
		}
		WhileSquareNumber squNum = new WhileSquareNumber();
