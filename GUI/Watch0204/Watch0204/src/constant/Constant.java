...
public class Constant {
	...
	public static final int FONT_SIZE_LARGE = 100;
	public static final int FONT_SIZE_SMALL = 50;
	public static final String TITLE = "ダイアログ";
	...
	public static final String PROPERTIES = "プロパティ";
	public static final String MENU = "メニュー";

	public static final int LARGE_FONT_SIZE = 100;

	public static final int MIDIUM_FONT_SIZE = 50;

	public static final int SMALL_FONT_SIZE = 25;

	public static final String BACKGROUND_COLOR = "バックグラウンドカラー";

	public static final String FONT_COLOR = "フォントカラー";
