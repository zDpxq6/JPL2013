...
public class Const {
	...
	public static final String コンストラクタパラメータ入力UIタイトル = "コンストラクタパラメータ入力UI";
	public static final int コンストラクタパラメータ入力UI幅 = 300;
	public static final int コンストラクタパラメータ入力UI高さ = 300;
	static final int コンストラクタ選択UI幅 = 300;
	static final int コンストラクタ選択UI高さ = 300;
	public static final String コンストラクタパラメータ入力UIオブジェクト生成ボタンラベル = "オブジェクト生成";
	...
	public static final String FrameName2 = "コンストラクタの選択";
