...
public class メンバUIフィールド決定ボタンリスナ implements ActionListener {
	...
	public メンバUIフィールド決定ボタンリスナ(Object selectedInstance2, JComboBox[] フィールド入力コンボボックスアレイ, ExceptionArea ea) {
		this.フィールド配列 = selectedInstance2.getClass().getDeclaredFields();
